...
PATH = r'This is a path for your local chromedriver'
driver = webdriver.Chrome(PATH)
# The following link is an example
link = "https://archive.sigma2.no/pages/public/datasetDetail.jsf?id=10.11582/2020.00030"
...
td_list[18] = td_list[18][td_list[18].find(">")+28:td_list[18].find("</div")]
...
RO = {	"id": id, 
		"type": "Aquí va el tipo. Nos lo traemos desde el motor de busqueda", 
		"name":title, 
